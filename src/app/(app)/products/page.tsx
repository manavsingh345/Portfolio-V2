...
const products = [
  {
    ...
    name: "GraphiDraw",
    description:
      "A web-based collaborative whiteboard that enables teams to sketch, draw, and organize ideas in a clean hand-drawn style.",
    ...
    image: "/images/products/Graphidraw.png",
  },
];
