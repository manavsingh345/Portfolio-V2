...
export const USER: User = {
  ...
  about: `
- **Software Engineer** and problem solver with **2+ years of experience** building reliable, scalable systems used by **hundreds of thousands of users**.
- Hold a **Bachelor's degree in Computer Science** and specialize in designing efficient, maintainable solutions.
